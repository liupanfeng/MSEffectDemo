...
public class MSVideoChannel {
     ...
     * default 1440
     */
    private int mPreviewDefaultWidth = 1080;
    /**
     * default 1080
     */
    private int mPreviewDefaultHeight = 1920;

    private float mPreviewScale;

    private int deviceId=Camera.CameraInfo.CAMERA_FACING_FRONT;

    private MSVideoChannel() {
        mPreviewScale = mPreviewDefaultWidth * 1f / mPreviewDefaultHeight;
    }
    ...
    private void startPreview(Activity activity, SurfaceHolder surfaceHolder) {
        ...
        setCameraDisplayOrientation(activity, deviceId);
